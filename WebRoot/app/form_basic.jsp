                                ...
                                <form class="am-form am-text-sm">
                                    <div class="am-form-group">
                                        <div class="am-g">
                                            ...
                                            <input class="am-u-md-10 form-control" id="doc-ipt-text-1"
                                                   placeholder="输入标题信息">
                                        </div>
                                    </div>
                                    ...
                                    <div class="am-form-group">
                                        <div class="am-g">
                                            <label class="am-u-md-2 am-md-text-right am-padding-left-0"
                                                   for="doc-ipt-email-1">电子邮箱</label>
                                            <input class="am-u-md-10 form-control" id="doc-ipt-email-1"
                                                   placeholder="输入电子邮件">
                                        </div>
                                    </div>
                                    ...
                                    <div class="am-form-group">
                                        <div class="am-g">
                                            ...
                                            <input type="password" class="am-u-md-10" id="doc-ipt-pwd-1"
                                                   placeholder="设置个密码吧">
                                        </div>
                                    </div>
                                    ...
                                    <div class="am-form-group">
                                        <div class="am-g">
                                            <label class="am-u-md-2 am-md-text-right am-padding-left-0"
                                                   for="doc-ipt-phd-1">提示</label>
                                            <input class="am-u-md-10 form-control" id="doc-ipt-phd-1"
                                                   placeholder="提示信息">
                                        </div>
                                    </div>
                                ...
                                <form class="am-form am-text-sm">
                                    <div class="am-form-group">
                                        <div class="am-g">
                                            ...
                                            <input class="am-form-field am-u-md-10" type="text" id="doc-ds-ipt-1"
                                                   placeholder="禁止输入" disabled>
                                        </div>
                                    </div>
            ...
            <div class="am-g">
                    ...
                    <div class="card-box">
                        ...
                        <form action="" class="am-form">
                            <div class="am-form-group am-form-success am-form-icon am-form-feedback">
                                <div class="am-g">
                                    <label class="am-form-label am-u-md-3 am-md-text-right am-padding-right-0"
                                           for="doc-ipt-success">验证成功</label>
                            ...
                            <div class="am-form-group am-form-warning">
                                <div class="am-g">
                                    <label class="am-form-label am-u-md-3 am-md-text-right am-padding-right-0"
                                           for="doc-ipt-warning">验证警告</label>
                                    <div class="am-u-md-6 am-u-end">
                            ...
                            <div class="am-form-group am-form-success am-form-icon am-form-feedback">
                                <div class="am-g">
                                    <label class="am-form-label am-u-md-3 am-md-text-right am-padding-right-0"
                                           for="doc-ipt-success2">验证成功</label>
                                    <div class="am-u-md-6 am-u-end">
                                        <input type="text" class="am-form-field am-radius" id="doc-ipt-success2"
                                               placeholder="验证成功">
                                        <span class="am-icon-check" id="rightPa"></span>
                                    </div>
                                </div>
                            ...
                            <div class="am-form-group am-form-warning am-form-icon am-form-feedback">
                                <div class="am-g">
                                    <label class="am-form-label am-u-md-3 am-md-text-right am-padding-right-0"
                                           for="doc-ipt-warm2">验证警告</label>
                                    <div class="am-u-md-6 am-u-end">
                                        <input type="text"
                                               class="am-form-field am-u-md-3 am-md-text-right am-padding-right-0 am-radius"
                                               id="doc-ipt-warm2" placeholder="验证警告">
                            ...
                            <div class="am-form-group am-form-error am-form-icon am-form-feedback">
                                <div class="am-g">
                                    <label class="am-form-label am-u-md-3 am-md-text-right am-padding-right-0"
                                           for="doc-ipt-error2">验证失败</label>
                                    <div class="am-u-md-6 am-u-end">
                                        <input type="text"
                                               class="am-form-field am-u-md-3 am-md-text-right am-padding-right-0 am-radius"
                                               id="doc-ipt-error2" placeholder="验证警告">
                ...
                <div class="am-u-md-6">
                    <div class="card-box">
                        ...
                        <form class="am-form">
                            <input class="am-form-field am-input-lg am-radius" type="text"
                                   placeholder="添加了 .am-input-lg">
                            <br/>
                            <input class="am-form-field am-radius" type="text" placeholder="默认的 input">
                            <br/>
                            <input class="am-form-field am-input-sm am-radius" type="text"
                                   placeholder="添加了 .am-input-sm">
                            <br/>
                        ...
                        <form class="am-form am-form-horizontal">
                            ...
                            <div class="am-form-group">
                                <label for="doc-ipt-pwd-2"
                                       class="am-u-sm-3 am-form-label am-text-right am-padding-right-0">密码</label>
                                <div class="am-u-sm-9">
                            ...
                            <div class="am-form-group">
                                <label for="doc-ipt-pwd-3"
                                       class="am-u-sm-3 am-form-label am-text-right am-padding-right-0">确认密码</label>
                                <div class="am-u-sm-9">
