...
<body>
<div class="navbar navbar-default" id="navbar" style="height: 55px">
        ...
        <div class="sidebar" id="sidebar">
            ...
            <ul class="nav nav-list">
                ...
                <li>
                    ...
                    <ul class="submenu">
                        <li>
                            <a href="javascript:void(0);" onclick="loadAddStyle()">
                        ...
                        <li>
                            <a href="javascript:void(0);" onclick="loadListAllStyle()">
                                <i class="icon-double-angle-right"></i>
                                查看分类
                            </a>
                        </li>
                ...
                <li>
                    ...
                    <ul class="submenu">
                        <li>
                            <a href="javascript:void(0);" onclick="loadListAllGoods();">
                                <i class="icon-double-angle-right"></i>
                                查看商品
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="javascript:void(0);" onclick="loadAddGoods();">
                                <i class="icon-double-angle-right"></i>
                                添加商品
                            </a>
                        </li>
                ...
                <li>
                    ...
                    <ul class="submenu">
                        <li>
                            <a href="javascript:void(0);" onclick="loadAllOrder();">
                                <i class="icon-double-angle-right"></i>
                                所有订单
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="javascript:void(0);" onclick="loadUnpaidOrder();">
                                <i class="icon-double-angle-right"></i>
                                未付款订单
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="javascript:void(0);" onclick="loadPaidOrder();">
                                <i class="icon-double-angle-right"></i>
                                已付款订单
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="javascript:void(0);" onclick="loadNotTakeOrder()">
                                <i class="icon-double-angle-right"></i>
                                未上菜订单
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="javascript:void(0);" onclick="loadCompletedOrder();">
                                <i class="icon-double-angle-right"></i>
                                已完成订单
                            </a>
                        </li>
